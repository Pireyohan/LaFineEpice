...
public class Tea {
	...
	private void initialize() {
		...
		TXT1.setText("Thé du Louvre - Côté Jardin.\r\n"
				+ "\r\n"
				+ "Thé vert gourmand aux notes de pomme, de prune et de coing, qui invite à une promenade à travers le jardin des Tuileries.");

		TXT2 = new JTextPane();
		TXT2.setEditable(false);
		TXT2.setForeground(new Color(205, 133, 63));
		TXT2.setFont(new Font("Tahoma", Font.ITALIC, 11));
		TXT2.setText("Mate Verde Chimarrão Bio.\r\n"
				+ "\r\n"
				+ "Boisson énergisante traditionnelle d'Amérique du Sud.\r\n"
				+ "Idéal pour commencer la journée et pour accompagner vos activités sportives.");
		...
		TXT3.setText("Grand Yunnan Impérial\r\n"
				+ "\r\n"
				+ "Fleuri et doux, doté d’une fine astringence, voici un délicieux thé du matin au parfum miellé, qui réveille sans exciter.");

		TXT5 = new JTextPane();
		TXT5.setEditable(false);
		TXT5.setForeground(new Color(205, 133, 63));
		TXT5.setFont(new Font("Tahoma", Font.ITALIC, 11));
		TXT5.setText("Vive Pâques ! Thé noir BIO\r\n"
				+ "\r\n"
				+ "Ce thé noir BIO aux éclats de cacao révèle des notes puissantes de chocolat noir.");

		TXT6 = new JTextPane();
		TXT6.setEditable(false);
		TXT6.setForeground(new Color(205, 133, 63));
		TXT6.setFont(new Font("Tahoma", Font.ITALIC, 11));
		TXT6.setText("Thé des Trésors\r\n"
				+ "\r\n"
				+ "Découvrez une recette créative et gourmande à base de thé vert aux notes de fruits caramélisés et aux éclats d’amande.");
		...
		TXT7.setText("Genmaicha Midori BIO\r\n"
				+ "\r\n"
				+ "Thé vert Bio et riz grillé de Shizuoka.");
		...
		TXT8.setText("DETOX Japonaise BIO\r\n"
				+ "\r\n"
				+ "Un délicieux mélange BIO de thé vert Sencha, spiruline et sarrasin, aux notes apaisantes de poire nashi.");

		TXT9 = new JTextPane();
		TXT9.setEditable(false);
		TXT9.setForeground(new Color(205, 133, 63));
		TXT9.setFont(new Font("Tahoma", Font.ITALIC, 11));
		TXT9.setText("Thé du Hammam\r\n"
				+ "\r\n"
				+ "Ce thé vert, gourmand et fruité, évoque la datte verte, la fleur d’oranger, la rose et les fruits rouges");

		TXT10 = new JTextPane();
		TXT10.setEditable(false);
		TXT10.setForeground(new Color(205, 133, 63));
		TXT10.setFont(new Font("Tahoma", Font.ITALIC, 11));
		TXT10.setText("Thé des Étoiles\r\n"
				+ "\r\n"
				+ "Création originale et savoureuse de thé vert aux notes gourmandes de fève tonka et de marron.");
